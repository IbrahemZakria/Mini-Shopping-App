...
class ProductRepoImpel extends ProductRepo {
  final RemoteDataSourseImpel RemoteDataSourcesImpel;

  ProductRepoImpel({required this.RemoteDataSourcesImpel});
  ...
  Future<Either<Failures, List<ProductModel>>> getAllProduct() async {
    try {
      ...
      products = await RemoteDataSourcesImpel.getAllProduct();
